<template>
  <aside class="admin-sidebar">
    ...
    <div class="admin-sidebar__footer">
      <p>社区管理规范</p>
      <small>保持内容真实、友善、有价值</small>
    </div>
  </aside>
</template>
<script>
import { Connection, DataBoard, Document, Sunrise, User } from "@element-plus/icons-vue";
export default {
  name: "AdminSidebar",
  components: { Connection, DataBoard, Document, Sunrise, User },
};
</script>
<style scoped>
.admin-sidebar {
