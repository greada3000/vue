...
export const api = Object.freeze({
  users: {
    ...
    changePassword: (id, password) => http.put(`/api/users/${id}/password`, {
  ...
  articles: {
    ...
    create: (article) => http.post('/api/articles', {
  ...
  reviews: {
    ...
    create: (review) => http.post('/api/reviews', {
  ...
  follows: {
    ...
    status: (followerId, followedUserId) => http.get('/api/follows/status', {
      params: { followerId, followedUserId }
    }),
    create: (followerId, followedUserId) => http.post('/api/follows', {
      followerId,
      followedUserId
    }),
    remove: (followerId, followedUserId) => http.delete('/api/follows', {
      params: { followerId, followedUserId }
    })
  }
})
