            ...
            <el-table-column label="操作">
              <template #default="scope">
                <el-tooltip class="item" effect="dark" content="修改用户" placement="top" :enterable="false">
                  <el-button type="primary" @click="showEditDialog(scope.row.circleId)">
                    <el-icon>
                      <EditIcon />
                    </el-icon>
                  </el-button>
                ...
                <el-tooltip class="item" effect="dark" content="圈子主页" placement="top" :enterable="false">
                  <el-button type="warning" @click="tocirclehome(scope.row.circleId)">
                    <el-icon>
                      <SearchIcon />
                    </el-icon>
                  </el-button>
                ...
                <el-tooltip class="item" effect="dark" content="删除圈子" placement="top" :enterable="false">
                  <el-button type="danger" @click="removeUserById(scope.row.circleId)">
                    <el-icon>
                      <DeleteIcon />
                    </el-icon>
                  </el-button>
...
export default {
  ...
  methods: {
    getUserList() {
      this.$api.circles.search(this.queryInfo).then((resp) => {
        let data = resp.data;
        if (data.success) {
          this.loginForm = {};
          console.log(data);
